...
{
 use retrieve::*;
 #[mod_pub_use(submodule_for_the_test)]
 #[test]
 fn test_in_situ()
 {
...
fn test_exo_situ()
{
 // The `m::submodule_for_the_test::VALUE` in this place should be compile error, but it is not an error for the `mod_use` pattern.
